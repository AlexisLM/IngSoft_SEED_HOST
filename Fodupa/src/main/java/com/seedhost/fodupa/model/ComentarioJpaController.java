...
public class ComentarioJpaController implements Serializable {
    ...
    public List<Comentario> findComentarioByPregunta(Pregunta pregunta){
    
        EntityManager em = getEntityManager();
        Query q = em.createNamedQuery("Comentario.findByIdpregunta")
                .setParameter("idpregunta", pregunta.getId());
